...
router.post("/", (0, validate_1.validateJSON)(RankAddSchemaValidation), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
router.put("/:id", (0, validate_1.validateJSON)(RankUpdateSchemaValidation), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
