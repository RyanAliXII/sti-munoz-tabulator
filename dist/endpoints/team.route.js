...
router.get("/", (0, validate_1.validatePemissions)(["Team.Read"]), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
router.post("/", (0, validate_1.validateJSON)(TeamCreateSchemaValidation), (0, validate_1.validatePemissions)(["Team.Create"]), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
router.put("/:id", (0, validate_1.validateJSON)(TeamUpdateSchemaValidation), (0, validate_1.validatePemissions)(["Team.Update"]), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const team = req.body;
...
router.delete("/:id", (0, validate_1.validatePemissions)(["Team.Delete"]), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
